...
public class TesteDAO {
    ...
    public static void main(String[] args) {
        ...
        Cliente c2 = new Cliente("Nathalia", "Feminio", new Date(16 / 04 / 1994), "52", "991298585", null, e1, "Email");
        Cliente c3 = new Cliente("Roberval", "Masculino", new Date(16 / 04 / 1994), "28", "778956", null, e1, "Email");
        Cliente c4 = new Cliente("Henrique", "Masculino", new Date(16 / 04 / 1994), "78", "86", null, e1, "Email");
